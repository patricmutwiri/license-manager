...
public class LicenseRuntimeController {
    ...
    public ApiPayloads.ValidationResponse validate(
        ...
        authorizeRuntime(clientKey, servletRequest);
    ...
    private void authorizeRuntime(String clientKey, HttpServletRequest servletRequest) {
        ...
        clientTokenService.requireRuntimeToken(clientKey);
    }
}
